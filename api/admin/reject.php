...
if ($stmt->execute()) {
    redirectWithMessage("../../admin/products.php", "success", "Đã từ chối sản phẩm #$id.");
} else {
    redirectWithMessage("../../admin/products.php", "error", "Từ chối sản phẩm thất bại. Vui lòng thử lại.");
}