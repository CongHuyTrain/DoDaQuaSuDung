...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2026 at 01:39 PM
...
CREATE TABLE `reviews` (
  ...
  `reviewed_user` int(11) DEFAULT NULL,
...
ALTER TABLE `reviews`
  ...
  ADD KEY `reviewed_user` (`reviewed_user`);
...
ALTER TABLE `reviews`
  ...
  ADD CONSTRAINT `reviews_ibfk_3` FOREIGN KEY (`reviewed_user`) REFERENCES `users` (`id`);
